...
import com.csounds.examples.drumrack.DrumMachineActivity;
...
import com.csounds.examples.tests.SynthActivity;


public class CsoundAndroidActivity extends BaseCsoundActivity {

	String[] testNames = new String[] { "Simple Test 1", "Simple Test 2", "MultiTouch XY", "Drumrack","Synthesizer"};
	@SuppressWarnings("rawtypes")
	Class[] activities = new Class[] { SimpleTest1Activity.class, SimpleTest2Activity.class, 
			 MultiTouchXYActivity.class,
			DrumMachineActivity.class,SynthActivity.class};
